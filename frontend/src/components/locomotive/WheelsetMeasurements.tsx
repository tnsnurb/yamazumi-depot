        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[1300px] w-[95vw] h-[85vh] bg-[#f8fafc] border-none shadow-2xl p-0 overflow-hidden flex flex-col">
                ...
                <div className="flex items-center justify-between px-8 py-5 bg-white border-b shrink-0">
                    <DialogTitle className="text-xl font-semibold text-slate-900 tracking-tight flex items-center gap-3">
                    ...
                    <DialogDescription className="sr-only">
                        ...
                        <Button
                            ...
                            variant="outline"
                            className="text-slate-600 border-slate-200 hover:bg-slate-50 font-semibold rounded-lg px-4 py-2 text-xs uppercase tracking-wider transition-all"
                        >
                        ...
                        <Button
                            ...
                            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg px-8 py-2 text-xs uppercase tracking-wider shadow-lg shadow-blue-100 transition-all hover:scale-105 active:scale-95"
                        >
                    ...
                    <div className="bg-[#0f172a] p-6 border-r border-slate-800 overflow-y-auto custom-scrollbar flex flex-col items-center">
                        ...
                        <div className="mt-auto pt-8 w-full">
                            <div className="bg-slate-800/40 rounded-xl p-4 border border-slate-700/50">
                                <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest mb-3">Статус борта:</p>
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center text-[11px]">
                                        <span className="text-slate-400">Техническое состояние</span>
                                        <span className="text-emerald-400 font-semibold">В норме</span>
                                    </div>
                        ...
                        {selectedWheel ? (
                            <div className="p-6 flex flex-col h-full gap-6">
                                ...
                                <div className="flex justify-between items-center bg-white px-5 py-3 rounded-xl shadow-sm border border-slate-200/60 shrink-0">
                                    <div className="flex items-center gap-4">
                                        <div className="h-10 w-10 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 font-semibold text-lg">
                                            {selectedWheel.axle}
                                        </div>
                                        <div>
                                            ...
                                            <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mt-1">Ось №{selectedWheel.axle} • Секция A</p>
                                        </div>
                                    </div>
                                    <Badge className="bg-emerald-50 text-emerald-700 border-emerald-100 uppercase font-semibold px-3 py-1 text-[9px] tracking-widest">
                                        Активно
                                    </Badge>
                                </div>
                                    ...
                                    <div className="mt-6 bg-white shrink-0 p-5 rounded-xl border border-slate-200/60 shadow-sm">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest mb-2">Технические допуски:</p>
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                                    <div className="flex flex-col">
                                                        <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Бандаж</span>
                                                        <span className="text-xs font-semibold text-slate-700">&gt;{LIMITS.tire_thickness.min} мм</span>
                                                    </div>
                                                    <div className="flex flex-col">
                                                        <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Прокат</span>
                                                        <span className="text-xs font-semibold text-slate-700">&lt;{LIMITS.wear.max} мм</span>
                                                    </div>
                                                    <div className="flex flex-col">
                                                        <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Гребень</span>
                                                        <span className="text-xs font-semibold text-slate-700">&gt;{LIMITS.flange_steepness.min} мм</span>
                                                    </div>
                                                    <div className="flex flex-col">
                                                        <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Диаметр</span>
                                                        <span className="text-xs font-semibold text-slate-700">&gt;{LIMITS.diameter.min} мм</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center text-slate-300 text-center p-12">
                                <div className="h-32 w-32 bg-white rounded-3xl shadow-xl shadow-slate-200/50 flex items-center justify-center mb-8 border border-slate-100">
                                    <Settings2 className="h-16 w-16 text-blue-500/20 animate-spin-slow" />
                                </div>
                                <h4 className="text-xl font-semibold text-slate-800 tracking-tight">Выберите колесо для замера</h4>
...
function Badge({ children, className }: any) {
    return <span className={cn("px-2 py-0.5 rounded text-[10px] font-semibold border", className)}>{children}</span>
}
