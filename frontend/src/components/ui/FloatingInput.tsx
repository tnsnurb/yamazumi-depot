        ...
        return (
            <div className={cn("floating-label-group group relative mt-2 w-full", error && "error", containerClassName)}>
                <input
                    type={type}
                    className={cn(
                        "peer block w-full px-3 py-2.5 text-sm bg-transparent border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 dark:border-gray-600 dark:focus:border-blue-500 transition-colors placeholder:opacity-0 focus:placeholder:opacity-100 dark:text-white",
                        className
                    )}
                ...
                <label className={cn(
                    ...
                    "peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-400 peer-focus:bg-white peer-focus:dark:bg-gray-900 peer-focus:font-medium",
